...
private RestTemplate restTemplate;
	...
	@Autowired
	RatingRestCommunicator(RestTemplateBuilder builder){
		this.restTemplate=builder.build();     //build restTemplate object here
	}
	...
	public void deleteRating(String id) {
		...
		restTemplate.exchange(url+id, HttpMethod.DELETE,requestEntity,Object.class);
